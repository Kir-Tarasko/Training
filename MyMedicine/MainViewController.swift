...
//  MyMedicine
//
//  Created by Kirill Tarasko on 08.08.2022.
//
...
class MainViewController: UITabBarController, UITabBarControllerDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        setupVC()
        navigationItem.rightBarButtonItem = UIBarButtonItem(barButtonSystemItem: .add, target: self, action: #selector(logout))
    }
}
